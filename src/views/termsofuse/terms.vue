...
<template>
    <HeaderComponent />
    <main class="main-container tou">
        <h2>利用規約</h2>
        <p>
            この利用規約（以下、「本規約」といいます。）は、TwimageDLerの管理人がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </p>
        <div class="tou-content">
            ...
            <div>
                ...
                <ol>
                    ...
                    <li>
                        本サービスにおいては、登録希望者が本規約に同意の上、管理人の定める方法によってユーザー登録を申請し、本サービスが示す手順で登録を行うことで、ユーザー登録が完了するものとします。
                    </li>
                </ol>
            </div>
            <div>
            ...
            <div>
                <h3>第13条（通知または連絡）</h3>
                <p>
                    ユーザーと管理人との間の通知または連絡は、ユーザーが登録の際に設定したメールアドレスによって行うものとします。管理人は,ユーザーから,管理人が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
                </p>
            </div>
            <div>
